...
function file_upload($picture) {
    ...
    $result->fileName = 'book-cover.png';
        ...
        if (in_array($fileExtension, $filesAllowed)) {
            if ($fileError === 0) {
                if ($fileSize < 500000) { //500kb this number is in bytes
                    ...
                    $result->ErrorMessage = "This picture is bigger than the allowed 500Kb. <br> Please choose a smaller one and update the book-entry.";
                    return $result;
                }
            } else {                              
